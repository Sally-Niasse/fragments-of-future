...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 10 mars 2022 à 14:48
...
INSERT INTO `utilisateurs` (`id_utilisateurs`, `login`, `password`, `save`) VALUES
(1, 'Reiko', '0000', 0),
...
--
ALTER TABLE `utilisateurs`
  MODIFY `id_utilisateurs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
